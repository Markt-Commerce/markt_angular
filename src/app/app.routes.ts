...
export const routes: Routes = [
  ...
  },
  {
    path: 'legal/terms',
    loadComponent: () =>
      import('./features/support/terms/terms.component').then(
        (m) => m.TermsComponent
      ),
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./features/offers/negotiation/negotiation.component').then(
  ...
  },
  {
    ...
    loadComponent: () =>
      import(
        './features/seller/verification/seller-verification.component'
  ...
  },
  {
    path: 'dev-navigation',
    loadComponent: () =>
      import('./features/dev/dev-navigation/dev-navigation.component').then(
        (m) => m.DevNavigationComponent
      ),
    data: { hideBreadcrumbs: true },
  },
  {
    path: 'dev-dashboard',
    loadComponent: () =>
      import('./features/dev/dev-dashboard.component').then(
  ...
  },
  {
    ...
    canActivate: [AuthGuard],
    loadComponent: () =>
      import('./shared/components/app-layout/app-layout.component').then(
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: 'search',
            loadComponent: () =>
              import('./features/marketplace/search/search.component').then(
                (m) => m.SearchComponent
              ),
          },
          {
            ...
            loadComponent: () =>
              import(
                './features/marketplace/product-listing/product-listing.component'
          ...
          },
          {
            ...
            loadComponent: () =>
              import(
                './features/marketplace/product-detail/product-detail.component'
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: 'feed',
            loadComponent: () =>
              import('./features/community/feed/feed.component').then(
                (m) => m.FeedComponent
              ),
          },
          {
            ...
            loadComponent: () =>
              import(
                './features/community/social-feed/social-feed.component'
          ...
          },
          {
            ...
            loadComponent: () =>
              import(
                './features/community/post-detail/post-detail.component'
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            loadComponent: () =>
              import(
                './features/profile/edit-profile/edit-profile.component'
          ...
          },
          {
            ...
            loadComponent: () =>
              import(
                './features/profile/user-profile/user-profile.component'
          ...
          },
          {
            ...
            loadComponent: () =>
              import(
                './features/profile/public-profile/public-profile.component'
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: 'history',
            loadComponent: () =>
              import('./features/orders/order-history.component').then(
          ...
          },
          {
            path: ':id/track',
            loadComponent: () =>
              import('./features/orders/order-tracking.component').then(
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            loadComponent: () =>
              import(
                './features/offers/negotiation/negotiation.component'
              ).then((m) => m.NegotiationComponent),
          },
          {
            path: 'create',
            loadComponent: () =>
              import(
                './features/offers/create-offer/create-offer.component'
          ...
          },
          {
            path: 'make/:id',
            loadComponent: () =>
              import('./features/offers/make-offer/make-offer.component').then(
                (m) => m.MakeOfferComponent
              ),
            canActivate: [RoleGuard],
            data: { requiredRole: 'buyer' },
          },
          {
            ...
            loadComponent: () =>
              import(
                './features/offers/offer-detail/offer-detail.component'
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            loadComponent: () =>
              import(
                './features/requests/my-requests/my-requests.component'
        ...
        children: [
          {
            ...
            loadComponent: () =>
              import(
                './features/chat/chat-overview/chat-overview.component'
              ).then((m) => m.ChatOverviewComponent),
          },
          {
            path: 'list',
            loadComponent: () =>
              import('./features/chat/chat-list/chat-list.component').then(
          ...
          },
          {
            path: 'start',
            loadComponent: () =>
              import('./features/chat/start-chat/start-chat.component').then(
                (m) => m.StartChatComponent
              ),
          },
          {
            path: ':id',
            loadComponent: () =>
              import('./features/chat/chat-detail/chat-detail.component').then(
        ...
        children: [
          {
            path: '',
            loadComponent: () =>
              import('./features/shops/shops.component').then(
                (m) => m.ShopsComponent
              ),
          },
          {
        ...
        children: [
          {
            path: 'feed',
            loadComponent: () =>
              import('./features/social/feed.component').then(
                (m) => m.FeedComponent
              ),
          },
          {
            path: 'stories',
            loadComponent: () =>
              import('./features/social/stories/stories.component').then(
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            path: 'privacy',
            loadComponent: () =>
              import('./features/settings/privacy/privacy.component').then(
          ...
          },
          {
            path: 'shipping',
            loadComponent: () =>
              import('./features/settings/shipping/shipping.component').then(
      ...
      },
      {
        ...
        children: [
            ...
            children: [
              {
                path: '',
                loadComponent: () =>
                  import('./features/seller/listings/listings.component').then(
              ...
              },
              {
                ...
                loadComponent: () =>
                  import(
                    './features/seller/listings/create-listing/create-listing.component'
              ...
              },
              {
                ...
                loadComponent: () =>
                  import(
                    './features/seller/listings/edit-listing/edit-listing.component'
                  ).then((m) => m.EditListingComponent),
                canActivate: [RoleGuard],
                data: { requiredRole: 'seller' },
              },
            ],
          },
          {
            path: 'analytics',
            loadComponent: () =>
              import('./features/seller/analytics/analytics.component').then(
          ...
          },
          {
            ...
            loadComponent: () =>
              import(
                './features/seller/start-cards/start-cards.component'
              ).then((m) => m.StartCardsComponent),
          },
        ],
      },
      {
      ...
      },
      {
        path: 'contact',
        loadComponent: () =>
          import('./features/support/contact/contact.component').then(
