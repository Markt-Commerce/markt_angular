  ...
  template: `
    ...
    <section class="bg-white rounded-xl border border-border p-6 mb-8">
      <div class="grid grid-cols-1 lg:grid-cols-4 gap-4">
        <div class="lg:col-span-2">
          <div class="relative">
            <fa-icon [icon]="faSearch" class="absolute left-3 top-1/2 transform -translate-y-1/2 text-muted"></fa-icon>
            <input 
              type="text" 
          ...
          <button 
            *ngFor="let tab of statusTabs()"
            ...
            <span 
              ...
              [class.bg-yellow-100]="tab.key === 'pending' && selectedTab() !== tab.key"
              [class.text-yellow-800]="tab.key === 'pending' && selectedTab() !== tab.key"
              [class.bg-blue-100]="tab.key === 'shipped' && selectedTab() !== tab.key"
              [class.text-blue-800]="tab.key === 'shipped' && selectedTab() !== tab.key"
              [class.bg-green-100]="tab.key === 'delivered' && selectedTab() !== tab.key"
              [class.text-green-800]="tab.key === 'delivered' && selectedTab() !== tab.key"
              [class.bg-red-100]="tab.key === 'cancelled' && selectedTab() !== tab.key"
              [class.text-red-800]="tab.key === 'cancelled' && selectedTab() !== tab.key">
              {{ tab.count }}
            </span>
          </button>
        </nav>
    ...
    <section class="space-y-6">
      ...
      <div *ngIf="isLoading()" class="space-y-6">
        <div *ngFor="let i of [1,2,3]" class="bg-white rounded-xl border border-border p-6 animate-pulse">
      ...
      <!-- Empty State -->
      <div *ngIf="!isLoading() && filteredOrders().length === 0" class="text-center py-12">
        ...
        <p class="text-gray-500 mb-6">You haven't placed any orders yet or no orders match your current filters.</p>
        <button 
          (click)="createNewOrder()"
      ...
      <!-- Order Cards -->
      <div *ngFor="let order of filteredOrders()" class="bg-white rounded-xl border border-border p-6 hover:shadow-lg transition-shadow">
        <!-- Order Header -->
        <div class="flex items-start justify-between mb-4">
          <div class="flex items-center space-x-4">
            <div 
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div class="lg:col-span-2">
            <div class="space-y-4" *ngIf="order.items.length > 1; else singleItem">
              <div *ngFor="let item of order.items" class="flex items-start space-x-4">
                <img 
                ...
                <div class="flex-1">
                  ...
                  <div class="flex items-center space-x-2 text-sm">
                    ...
                    <span class="font-medium text-dark">{{ item.price * item.quantity | currency:'NGN':'symbol':'1.2-2' }}</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              <div class="flex items-start space-x-4">
                ...
                <div class="flex-1">
                  ...
                  <div class="flex items-center space-x-2 text-sm">
                    ...
                    <span class="text-muted">•</span>
                    <span class="font-medium text-dark">{{ order.items[0].price * order.items[0].quantity | currency:'NGN':'symbol':'1.2-2' }}</span>
                  </div>
                </div>
              </div>
            </ng-template>
        ...
        <div *ngIf="order.items.length > 1" class="mt-4 pt-4 border-t border-border">
          <div class="flex items-center justify-between text-sm">
            <span class="text-muted" *ngIf="order.status === 'shipped'">
              Estimated delivery: {{ getEstimatedDelivery(order) }}
            </span>
            <span class="font-semibold text-dark">Total: {{ order.total | currency:'NGN':'symbol':'1.2-2' }}</span>
          </div>
        </div>
      </div>
    </section>
    ...
    <div class="fixed right-4 top-1/2 transform -translate-y-1/2 space-y-3 z-10">
      <button 
...
export class OrderHistoryComponent implements OnInit {
  ...
  statusTabs = signal<OrderStatusTab[]>([
    { key: 'all', label: 'All Orders', count: 24, color: 'text-white', bgColor: 'bg-primary' },
    { key: 'pending', label: 'Processing', count: 3, color: 'text-yellow-800', bgColor: 'bg-yellow-100' },
    { key: 'shipped', label: 'Shipped', count: 8, color: 'text-blue-800', bgColor: 'bg-blue-100' },
    { key: 'delivered', label: 'Delivered', count: 12, color: 'text-green-800', bgColor: 'bg-green-100' },
    { key: 'cancelled', label: 'Cancelled', count: 1, color: 'text-red-800', bgColor: 'bg-red-100' }
  ]);
                ...
                images: [
                  {
                    ...
                    media: {
                      ...
                      original_url: '/assets/images/products/premium-wireless-headphones.jpg',
                      thumbnail_url: '/assets/images/products/premium-wireless-headphones.jpg',
                      mobile_url: '/assets/images/products/premium-wireless-headphones.jpg',
                      tablet_url: '/assets/images/products/premium-wireless-headphones.jpg',
                      desktop_url: '/assets/images/products/premium-wireless-headphones.jpg',
                      social_square_url: '/assets/images/products/premium-wireless-headphones.jpg',
                      social_post_url: '/assets/images/products/premium-wireless-headphones.jpg',
                      social_story_url: '/assets/images/products/premium-wireless-headphones.jpg',
                      width: 400,
                      height: 400,
                      file_size: 50000,
                ...
                images: [
                  {
                    ...
                    media: {
                      ...
                      mobile_url: '/assets/images/products/calculus-textbook.png',
                      tablet_url: '/assets/images/products/calculus-textbook.png',
                      desktop_url: '/assets/images/products/calculus-textbook.png',
                      social_square_url: '/assets/images/products/calculus-textbook.png',
                      social_post_url: '/assets/images/products/calculus-textbook.png',
                      social_story_url: '/assets/images/products/calculus-textbook.png',
                      width: 400,
                      height: 400,
                      file_size: 50000,
                      mime_type: 'image/jpeg',
                ...
                images: [
                  {
                    ...
                    media: {
                      ...
                      desktop_url: '/assets/images/products/sony-headphones.png',
                      social_square_url: '/assets/images/products/sony-headphones.png',
                      social_post_url: '/assets/images/products/sony-headphones.png',
                      social_story_url: '/assets/images/products/sony-headphones.png',
                      width: 400,
                      height: 400,
                      file_size: 50000,
                      mime_type: 'image/jpeg',
                ...
                images: [
                  {
                    ...
                    media: {
                      ...
                      original_url: '/assets/images/products/vintage-leather-jacket.jpg',
                      thumbnail_url: '/assets/images/products/vintage-leather-jacket.jpg',
                      mobile_url: '/assets/images/products/vintage-leather-jacket.jpg',
                      tablet_url: '/assets/images/products/vintage-leather-jacket.jpg',
                      desktop_url: '/assets/images/products/vintage-leather-jacket.jpg',
                      social_square_url: '/assets/images/products/vintage-leather-jacket.jpg',
                      social_post_url: '/assets/images/products/vintage-leather-jacket.jpg',
                      social_story_url: '/assets/images/products/vintage-leather-jacket.jpg',
                      width: 400,
                      height: 400,
                      file_size: 50000,
                      mime_type: 'image/jpeg',
