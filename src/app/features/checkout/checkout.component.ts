  ...
  template: `
    <div class="min-h-screen bg-gray-50">
      ...
      <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div
          class="rounded-md border border-green-200 bg-green-50 text-green-800 px-4 py-2 text-sm"
        >
          Offer accepted. Item added to your cart. You can complete checkout
          below.
        </div>
        }
        ...
        @if (errorMessage) {
        <div
          class="rounded-md border border-red-200 bg-red-50 text-red-800 px-4 py-3 text-sm mb-4"
        >
        ...
        @if (loading) {
        <div
          class="rounded-md border border-blue-200 bg-blue-50 text-blue-800 px-4 py-3 text-sm mb-4"
        >
          <div class="flex items-center">
            <div
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            ...
            <div class="bg-white rounded-lg border border-gray-200">
              ...
              >
                ...
                <fa-icon
                  [icon]="faTruck"
                  class="w-5 h-5 text-markt-primary"
                ></fa-icon>
              </div>
              <div class="p-6">
                <form
                ...
                >
                  ...
                  <div class="flex justify-end">
                    <button
                      type="submit"
                      [disabled]="
                        shippingForm.invalid || isProcessing || !canCheckout
                      "
                ...
                >
                  ...
                  <div>
                    ...
                    <div class="grid grid-cols-3 gap-3">
                      ...
                      <button
                        ...
                        [class.bg-markt-primary]="
                          selectedPaymentMethod === 'card'
                        "
                        [class.text-white]="selectedPaymentMethod === 'card'"
                        [class.border-markt-primary]="
                          selectedPaymentMethod === 'card'
                        "
                  ...
                  <div class="flex justify-between">
                    ...
                    <button
                      type="submit"
                      [disabled]="
                        paymentForm.invalid || isProcessing || !canCheckout
                      "
                      class="bg-markt-primary text-white px-6 py-2 rounded-md hover:bg-markt-secondary transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                      Review Order
          ...
          <div class="lg:col-span-1">
            ...
            >
              ...
              <!-- Security Badges -->
              <div
                class="mt-6 flex items-center justify-center space-x-4 text-xs text-muted"
              >
                <div class="flex items-center">
                  <fa-icon
                    [icon]="faShieldAlt"
...
export class CheckoutComponent implements OnInit {
  ...
  selectPayment(methodId: string): void {
    ...
    this.paymentForm
      .get('paymentMethod')
      ?.setValue(methodId, { emitEvent: false });
  }
